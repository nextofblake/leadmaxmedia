  ...
  <div ref="viewProfile" class="view view--white">
    ...
    <transition name="rise">
      <div v-if="showHome" class="home-card">
        <!-- HOME: free audit -->
        <VideoCard  :src="videoService.intro" :bounceIcon="videoCardBounce" style="margin-top: 2vh; max-width: 500px;">
        ...
        <!-- HOME: meeting CTA -->
        <VideoCard :src="videoService.intro" style="margin-top: 2vh; max-width: 500px;">
...
export default {
  ...
  methods: {
    ...
    playVideo() {
      ...
      setInterval(this.setControlWidth, 500) // Set video control bar width dynamically
    },
    onEndedVideo() {
